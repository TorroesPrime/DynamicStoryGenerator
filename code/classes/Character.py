...
class character:
    def __init__(self,name,weap,ball,stre,toug,agil,inte,perc,will,fell):
        self.name = name
    ...
    def __characterSheet__(self):
        ...
        print(side+statWeaponSkill+side+statBallisticSkill+side+statStrength+side+statT+side+statAg+side+statInt+side\
